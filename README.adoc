...
:url-demo: https://devcntr-org.github.io/antora-dark-theme
...
image::https://github.com/devcntr-org/antora-dark-theme/actions/workflows/deploy.yml/badge.svg[Build Status,link=https://github.com/devcntr-org/antora-dark-theme/actions/workflows/deploy.yml]
...
ui:
  bundle:
    url: https://github.com/devcntr-org/antora-dark-theme/releases/latest/download/ui-bundle.zip
    snapshot: true
----
