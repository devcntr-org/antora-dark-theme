...
image::https://github.com/asciidoc-supplemental/antora-dark-theme/actions/workflows/deploy.yml/badge.svg[Build Status,link=https://github.com/asciidoc-supplemental/antora-dark-theme/actions/workflows/deploy.yml]
...
ui:
  bundle:
    url: https://github.com/asciidoc-supplemental/antora-dark-theme/releases/latest/download/ui-bundle.zip
    snapshot: true
----
